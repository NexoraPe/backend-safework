...
public class IncidentCommandServiceImpl implements IncidentCommandService {
    ...
    public Optional<Incident> handle(CreateIncidentCommand command){
        ...
        var company = companyRepository.findById(command.companyId()).orElseThrow(() -> new RuntimeException("Company not found"));;
    ...
    public Optional<Assignment> handle(CreateAssignmentCommand command){
        ...
        //NO LLAMAR AL REPOSITORIO DE ASSIGMENT, EL INCIDENT YA SE ENCARGA DE LA CREACION EN LA BASE DE DATOS
